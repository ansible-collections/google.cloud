...
def resource_to_request(module):
    request = {
        ...
        "certSerialNumber": module.params.get("cert_serial_number"),
        "commonName": module.params.get("common_name"),
        "createTime": module.params.get("create_time"),
...
def self_link(module):
    ...
    return "https://sqladmin.googleapis.com/sql/v1beta4/projects/{project}/instances/{instance}/sslCerts/{sha1_fingerprint}".format(
        **res
    )
...
def collection(module):
    ...
    return "https://sqladmin.googleapis.com/sql/v1beta4/projects/{project}/instances/{instance}/sslCerts".format(
        **res
    )
...
def response_to_hash(module, response):
    return {
        ...
        "certSerialNumber": response.get("certSerialNumber"),
...
def wait_for_operation(module, response):
    ...
    return fetch_resource(
        module, navigate_hash(wait_done, ["targetLink"]), "sql#sslCert"
    )
