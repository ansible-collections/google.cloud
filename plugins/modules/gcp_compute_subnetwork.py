...
def update_fields(module, request, response):
    ...
    if response.get("secondaryIpRanges") != request.get(
        "secondaryIpRanges"
    ) or response.get("privateIpv6GoogleAccess") != request.get(
        "privateIpv6GoogleAccess"
    ):
...
def ip_cidr_range_update(module, request, response):
    ...
    auth.post(
        ...
        {"ipCidrRange": module.params.get("ip_cidr_range")},
    )
...
def secondary_ip_ranges_update(module, request, response):
    ...
    auth.patch(
        ...
        {
            "secondaryIpRanges": SubnetworkSecondaryiprangesArray(
                module.params.get("secondary_ip_ranges", []), module
            ).to_request(),
            "privateIpv6GoogleAccess": module.params.get("private_ipv6_google_access"),
        },
    )
...
def private_ip_google_access_update(module, request, response):
    ...
    auth.post(
        ...
        {"privateIpGoogleAccess": module.params.get("private_ip_google_access")},
    )
...
def self_link(module):
    return "https://compute.googleapis.com/compute/v1/projects/{project}/regions/{region}/subnetworks/{name}".format(
        **module.params
    )


def collection(module):
    return "https://compute.googleapis.com/compute/v1/projects/{project}/regions/{region}/subnetworks".format(
        **module.params
    )
...
def response_to_hash(module, response):
    return {
        ...
        "gatewayAddress": response.get("gatewayAddress"),
        "id": response.get("id"),
        "ipCidrRange": response.get("ipCidrRange"),
        "name": response.get("name"),
        "network": replace_resource_dict(module.params.get("network", {}), "selfLink"),
        "secondaryIpRanges": SubnetworkSecondaryiprangesArray(
            response.get("secondaryIpRanges", []), module
        ).from_response(),
        "privateIpGoogleAccess": response.get("privateIpGoogleAccess"),
        "privateIpv6GoogleAccess": response.get("privateIpv6GoogleAccess"),
        "region": module.params.get("region"),
    }
...
def wait_for_operation(module, response):
    ...
    return fetch_resource(
        module, navigate_hash(wait_done, ["targetLink"]), "compute#subnetwork"
    )
...
class SubnetworkSecondaryiprangesArray(object):
    ...
    def _response_from_item(self, item):
        return remove_nones_from_dict(
            {"rangeName": item.get("rangeName"), "ipCidrRange": item.get("ipCidrRange")}
        )
