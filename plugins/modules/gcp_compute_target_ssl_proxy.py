...
def proxy_header_update(module, request, response):
    ...
    auth.post(
        ...
        {"proxyHeader": module.params.get("proxy_header")},
    )
...
def service_update(module, request, response):
    ...
    auth.post(
        ...
        {
            "service": replace_resource_dict(
                module.params.get("service", {}), "selfLink"
            )
        },
    )
...
def resource_to_request(module):
    request = {
        ...
        "proxyHeader": module.params.get("proxy_header"),
        "service": replace_resource_dict(module.params.get("service", {}), "selfLink"),
        "sslCertificates": replace_resource_dict(
            module.params.get("ssl_certificates", []), "selfLink"
        ),
        "sslPolicy": replace_resource_dict(
...
def self_link(module):
    return "https://compute.googleapis.com/compute/v1/projects/{project}/global/targetSslProxies/{name}".format(
        **module.params
    )


def collection(module):
    return "https://compute.googleapis.com/compute/v1/projects/{project}/global/targetSslProxies".format(
        **module.params
    )
...
def response_to_hash(module, response):
    return {
        ...
        "id": response.get("id"),
        "name": module.params.get("name"),
        "proxyHeader": response.get("proxyHeader"),
...
def wait_for_operation(module, response):
    ...
    return fetch_resource(
        module, navigate_hash(wait_done, ["targetLink"]), "compute#targetSslProxy"
    )
