...
def self_link(module):
    return "https://compute.googleapis.com/compute/v1/projects/{project}/regions/{region}/targetVpnGateways/{name}".format(
        **module.params
    )


def collection(module):
    return "https://compute.googleapis.com/compute/v1/projects/{project}/regions/{region}/targetVpnGateways".format(
        **module.params
    )
...
def response_to_hash(module, response):
    return {
        ...
        "forwardingRules": response.get("forwardingRules"),
    }
...
def wait_for_operation(module, response):
    ...
    return fetch_resource(
        module, navigate_hash(wait_done, ["targetLink"]), "compute#targetVpnGateway"
    )
