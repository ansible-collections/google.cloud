...
def resource_to_request(module):
    request = {"name": name_pattern(module.params.get("name"), module)}
    return_vals = {}
...
def self_link(module):
    return (
        "https://sourcerepo.googleapis.com/v1/projects/{project}/repos/{name}".format(
            **module.params
        )
    )
...
def collection(module):
    return "https://sourcerepo.googleapis.com/v1/projects/{project}/repos".format(
        **module.params
    )
