...
options:
        ...
        suboptions:
          ...
          args:
            description:
              ...
              - If the image does not define an entrypoint, the first element in args is used as the entrypoint, and the remainder will be used as arguments.
            elements: str
            type: list
          dir:
            description:
  ...
  included_files:
    description:
      ...
      - If any of the files altered in the commit pass the ignoredFiles filter and includedFiles is not empty, then we make sure that at least one of those files matches a includedFiles glob.
...
class ApprovalConfig(gcp_v2.Resource):
    def _request(self):
        return {
...
class BitbucketServerTriggerConfig(gcp_v2.Resource):
    def _request(self):
        return {
            ...
            "pullRequest": gcp_v2.remove_empties(
                BitbucketServerTriggerConfigPullRequest(self.request.get("pull_request", {})).to_request()
            ),  # remove empty values
            "push": gcp_v2.remove_empties(
                BitbucketServerTriggerConfigPush(self.request.get("push", {})).to_request()
            ),  # remove empty values
            "repoSlug": self.request.get("repo_slug"),
        }


class BitbucketServerTriggerConfigPullRequest(gcp_v2.Resource):
    def _request(self):
        return {
...
class BitbucketServerTriggerConfigPush(gcp_v2.Resource):
    def _request(self):
        return {
            "branch": self.request.get("branch"),
            "invertRegex": self.request.get("invert_regex"),
...
class Build(gcp_v2.Resource):
    def _request(self):
        return {
            "artifacts": gcp_v2.remove_empties(
                BuildArtifacts(self.request.get("artifacts", {})).to_request()
            ),  # remove empty values
            "availableSecrets": gcp_v2.remove_empties(
                BuildAvailableSecrets(self.request.get("available_secrets", {})).to_request()
            ),  # remove empty values
            "images": self.request.get("images"),
            "logsBucket": self.request.get("logs_bucket"),
            "options": gcp_v2.remove_empties(
                BuildOptions(self.request.get("options", {})).to_request()
            ),  # remove empty values
            "queueTtl": self.request.get("queue_ttl"),
            "secrets": [BuildSecret(item).to_request() for item in (self.request.get("secret") or [])],
            "source": gcp_v2.remove_empties(
                BuildSource(self.request.get("source", {})).to_request()
            ),  # remove empty values
...
class BuildArtifacts(gcp_v2.Resource):
    def _request(self):
        return {
            "images": self.request.get("images"),
            "mavenArtifacts": [
            ...
            "objects": gcp_v2.remove_empties(
                BuildArtifactsObjects(self.request.get("objects", {})).to_request()
            ),  # remove empty values
            "pythonPackages": [
...
class BuildArtifactsMavenArtifact(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildArtifactsNpmPackage(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildArtifactsObjects(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildArtifactsObjectsTiming(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildArtifactsPythonPackage(gcp_v2.Resource):
    def _request(self):
        return {
            "paths": self.request.get("paths"),
            "repository": self.request.get("repository"),
...
class BuildAvailableSecrets(gcp_v2.Resource):
    def _request(self):
        return {
            "secretManager": [
...
class BuildAvailableSecretsSecretManager(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildOptions(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildOptionsVolume(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildSecret(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildSource(gcp_v2.Resource):
    def _request(self):
        return {
            "repoSource": gcp_v2.remove_empties(
                BuildSourceRepoSource(self.request.get("repo_source", {})).to_request()
            ),  # remove empty values
            "storageSource": gcp_v2.remove_empties(
                BuildSourceStorageSource(self.request.get("storage_source", {})).to_request()
            ),  # remove empty values
        }


class BuildSourceRepoSource(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildSourceStorageSource(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildStep(gcp_v2.Resource):
    def _request(self):
        return {
...
class BuildStepVolume(gcp_v2.Resource):
    def _request(self):
        return {
            "name": self.request.get("name"),
            "path": self.request.get("path"),
...
class DeveloperConnectEventConfig(gcp_v2.Resource):
    def _request(self):
        return {
            "gitRepositoryLink": self.request.get("git_repository_link"),
            "pullRequest": gcp_v2.remove_empties(
                DeveloperConnectEventConfigPullRequest(self.request.get("pull_request", {})).to_request()
            ),  # remove empty values
            "push": gcp_v2.remove_empties(
                DeveloperConnectEventConfigPush(self.request.get("push", {})).to_request()
            ),  # remove empty values
        }

    def _response(self):
        return {
            "gitRepositoryLinkType": self.response.get("gitRepositoryLinkType"),
        }


class DeveloperConnectEventConfigPullRequest(gcp_v2.Resource):
    def _request(self):
        return {
            "branch": self.request.get("branch"),
            "commentControl": self.request.get("comment_control"),
...
class DeveloperConnectEventConfigPush(gcp_v2.Resource):
    def _request(self):
        return {
            "branch": self.request.get("branch"),
            "invertRegex": self.request.get("invert_regex"),
...
class GitFileSource(gcp_v2.Resource):
    def _request(self):
        return {
...
class Github(gcp_v2.Resource):
    def _request(self):
        return {
            ...
            "push": gcp_v2.remove_empties(GithubPush(self.request.get("push", {})).to_request()),  # remove empty values
        }


class GithubPullRequest(gcp_v2.Resource):
    def _request(self):
        return {
            "branch": self.request.get("branch"),
            "commentControl": self.request.get("comment_control"),
...
class GithubPush(gcp_v2.Resource):
    def _request(self):
        return {
            "branch": self.request.get("branch"),
            "invertRegex": self.request.get("invert_regex"),
...
class PubsubConfig(gcp_v2.Resource):
    def _request(self):
        return {
...
class RepositoryEventConfig(gcp_v2.Resource):
    def _request(self):
        return {
            "pullRequest": gcp_v2.remove_empties(
            ...
            "push": gcp_v2.remove_empties(
                RepositoryEventConfigPush(self.request.get("push", {})).to_request()
            ),  # remove empty values
            "repository": self.request.get("repository"),
        }


class RepositoryEventConfigPullRequest(gcp_v2.Resource):
    def _request(self):
        return {
            "branch": self.request.get("branch"),
            "commentControl": self.request.get("comment_control"),
...
class RepositoryEventConfigPush(gcp_v2.Resource):
    def _request(self):
        return {
            "branch": self.request.get("branch"),
            "invertRegex": self.request.get("invert_regex"),
...
class SourceToBuild(gcp_v2.Resource):
    def _request(self):
        return {
            "bitbucketServerConfig": self.request.get("bitbucket_server_config"),
            "githubEnterpriseConfig": self.request.get("github_enterprise_config"),
...
class TriggerTemplate(gcp_v2.Resource):
    def _request(self):
        return {
            "branchName": self.request.get("branch_name"),
            "commitSha": self.request.get("commit_sha"),
...
class WebhookConfig(gcp_v2.Resource):
    def _request(self):
        return {
...
class CloudBuild(gcp_v2.Resource):
    def _request(self):
        return {
            "approvalConfig": gcp_v2.remove_empties(
                ApprovalConfig(self.request.get("approval_config", {})).to_request()
            ),  # remove empty values
            "bitbucketServerTriggerConfig": gcp_v2.remove_empties(
                BitbucketServerTriggerConfig(self.request.get("bitbucket_server_trigger_config", {})).to_request()
            ),  # remove empty values
            "build": gcp_v2.remove_empties(Build(self.request.get("build", {})).to_request()),  # remove empty values
            "description": self.request.get("description"),
            "developerConnectEventConfig": gcp_v2.remove_empties(
                DeveloperConnectEventConfig(self.request.get("developer_connect_event_config", {})).to_request()
            ),  # remove empty values
            "disabled": self.request.get("disabled"),
            "filename": self.request.get("filename"),
            "filter": self.request.get("filter"),
            "gitFileSource": gcp_v2.remove_empties(
                GitFileSource(self.request.get("git_file_source", {})).to_request()
            ),  # remove empty values
            "github": gcp_v2.remove_empties(Github(self.request.get("github", {})).to_request()),  # remove empty values
            ...
            "name": self.request.get("name"),
            "pubsubConfig": gcp_v2.remove_empties(
                PubsubConfig(self.request.get("pubsub_config", {})).to_request()
            ),  # remove empty values
            "repositoryEventConfig": gcp_v2.remove_empties(
                RepositoryEventConfig(self.request.get("repository_event_config", {})).to_request()
            ),  # remove empty values
            "serviceAccount": self.request.get("service_account"),
            "sourceToBuild": gcp_v2.remove_empties(
                SourceToBuild(self.request.get("source_to_build", {})).to_request()
            ),  # remove empty values
            "substitutions": self.request.get("substitutions"),
            "tags": [str(item) for item in (self.request.get("tags") or [])],
            "triggerTemplate": gcp_v2.remove_empties(
                TriggerTemplate(self.request.get("trigger_template", {})).to_request()
            ),  # remove empty values
            "webhookConfig": gcp_v2.remove_empties(
                WebhookConfig(self.request.get("webhook_config", {})).to_request()
            ),  # remove empty values
        }
...
def main():
    ...
    module = gcp_v2.Module(
        argument_spec=dict(
            ...
            developer_connect_event_config=dict(
                type="dict",
                options=dict(
    ...
    op_configs = gcp_v2.ResourceOpConfigs(
        ...
        base_uri="projects/{project}/locations/{location}/triggers",
        configs={
    ...
    resource = CloudBuild(
        request, module=module, product="CloudBuild", kind="cloudbuild#trigger", op_configs=op_configs
    )
