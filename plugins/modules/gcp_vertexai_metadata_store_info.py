...
extends_documentation_fragment:
  - google.cloud.gcp
module: gcp_vertexai_metadata_store_info
notes:
...
requirements:
  ...
  - requests >= 2.18.4
  - google-auth >= 2.25.1
short_description: List GCP vertexai.MetadataStore resources
"""  # noqa: E501

EXAMPLES = r"""
- name: List all gcp_vertexai_metadata_store_info resources
  google.cloud.gcp_vertexai_metadata_store_info:
    project: "{{ gcp_project }}"
    auth_kind: "{{ gcp_cred_kind }}"
    service_account_file: "{{ gcp_cred_file }}"
  register: result

- name: List gcp_vertexai_metadata_store_info resources matching given filters
  google.cloud.gcp_vertexai_metadata_store_info:
    filters:
...
resources:
  contains:
    ...
    updateTime:
      ...
      returned: success
      type: str
  description: List of VertexAI.MetadataStore resources matching the supplied filters. May be empty, contain a single resource, or multiple resources.
  elements: dict
  returned: always
  type: list
"""  # noqa: E501
...
def main():
    ...
    resources = info.list(link, key="metadataStores", filters=filter_exprs)
