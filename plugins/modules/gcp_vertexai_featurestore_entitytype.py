...
description:
  - >-
    An entity type is a type of object in a system that needs to be modeled and have stored information about. For example, driver is an entity
...
options:
        ...
        suboptions:
          anomaly_detection_baseline:
            description:
              ...
              - >-
                The value must be one of the values below: * LATEST_STATS: Choose the later one statistics generated by either most recent snapshot analysis

                or previous import features analysis.
        ...
        suboptions:
          disabled:
            ...
            description:
              ...
              - >-
                ...
                snapshot analysis monitoring with monitoringInterval for Features under it.
            type: bool
          monitoring_interval:
            description:
          ...
          monitoring_interval_days:
            ...
            description:
              ...
              - >-
                If both FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days and

                [FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval][] are set when creating/updating EntityTypes/Features,

                FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days will be used.
            type: int
          staleness_days:
            default: 21
            description:
  ...
  offline_storage_ttl_days:
    ...
    description:
      ...
      - >-
        The Feature Store offline storage periodically removes obsolete feature values older than offlineStorageTtlDays since the feature generation
