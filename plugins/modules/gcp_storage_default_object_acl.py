...
def self_link(module):
    ...
    return "https://storage.googleapis.com/storage/v1/b/{bucket}/defaultObjectAcl/{entity}".format(
        **res
    )
...
def collection(module):
    ...
    return (
        "https://storage.googleapis.com/storage/v1/b/{bucket}/defaultObjectAcl".format(
            **res
        )
    )
...
def response_to_hash(module, response):
    return {
        ...
        "projectTeam": DefaultObjectACLProjectteam(
