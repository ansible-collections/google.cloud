...
def self_link(module):
    return "https://runtimeconfig.googleapis.com/v1beta1/projects/{project}/configs/{config}/variables/{name}".format(
        **module.params
    )


def collection(module):
    return "https://runtimeconfig.googleapis.com/v1beta1/projects/{project}/configs/{config}/variables".format(
        **module.params
    )
...
def response_to_hash(module, response):
    return {"value": response.get("value"), "text": response.get("text")}
...
def name_pattern(name, module):
    ...
    if not re.match(regex, name):
        name = "projects/{project}/configs/{config}/variables/{name}".format(
            **module.params
        )
