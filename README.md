...
* Binary Authorization Attestor (gcp_binaryauthorization_attestor, gcp_binaryauthorization_attestor_info)
* Binary Authorization Policy (gcp_binaryauthorization_policy, gcp_binaryauthorization_policy_info)
...
* Container Analysis Note (gcp_containeranalysis_note, gcp_containeranalysis_note_info)
